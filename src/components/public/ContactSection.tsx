              ...
              <div className="bg-white p-8 border border-[#EBE5DE] shadow-sm flex-1">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-pgp-navy text-sm font-bold mb-1">Kantor Pusat</h3>
                  ...
                  <div className="flex items-start gap-4">
                    <MapPin className="text-pgp-red shrink-0 mt-0.5" size={20} />
                    <div>
                      <h3 className="text-pgp-navy text-sm font-bold mb-1">Kantor Operasional</h3>
                      <p className="text-[#666] text-sm leading-relaxed">
              ...
              <div className="bg-pgp-navy p-8 text-white">
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-pgp-red">Tutup</span>
                  </div>
                </div>
              </div>
            </div>
