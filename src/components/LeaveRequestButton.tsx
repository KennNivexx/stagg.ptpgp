  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#CC0000] hover:bg-[#aa0000] text-white rounded-xl text-xs font-bold transition-colors shadow-md shadow-red-900/10"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 z-10">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-[#1A2530]">Ajukan Cuti</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input id="leave-start" type="date" name="start_date" required className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-[#CC0000] focus:ring-1 focus:ring-[#CC0000] outline-none" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-600 mb-1.5" htmlFor="leave-end">Tanggal Selesai</label>
                    <input id="leave-end" type="date" name="end_date" required className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-[#CC0000] focus:ring-1 focus:ring-[#CC0000] outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-600 mb-1.5" htmlFor="leave-reason">Alasan</label>
                  <textarea id="leave-reason" name="reason" rows={3} placeholder="Alasan pengajuan cuti..." className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-[#CC0000] focus:ring-1 focus:ring-[#CC0000] outline-none resize-none" />
                </div>
                ...
                <button type="submit" disabled={loading} className="w-full bg-[#CC0000] hover:bg-[#aa0000] disabled:opacity-60 text-white font-bold text-sm py-2.5 rounded-xl transition-colors flex items-center justify-center gap-2">
