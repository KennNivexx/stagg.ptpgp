...
export default function DepartmentLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex font-sans text-slate-800">
      ...
      <aside className={`w-64 lg:w-20 xl:w-64 bg-emerald-900 text-white flex flex-col fixed inset-y-0 left-0 z-40 transition-transform duration-300 border-r border-emerald-950 lg:translate-x-0 lg:static lg:h-screen ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
