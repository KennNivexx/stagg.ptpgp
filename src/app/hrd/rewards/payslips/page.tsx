...
import { FileText, Download, DollarSign, Clock, Users } from "lucide-react";
...
export default async function PayslipsPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-[#1A2530] mb-2">Slip Gaji</h1>
        <p className="text-sm text-gray-500">Kelola dan distribusikan slip gaji karyawan.</p>
      </div>
